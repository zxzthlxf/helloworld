...
func main() {
	engine, err := xorm.NewEngine("odbc", "Driver={PostgreSQL Unicode};Server=10.203.60.62;Port=30100;UID=comm;PWD=SZtest@123;Database=macbs_db01;Pooling=true;Min Pool Size=1")
	if err != nil {
